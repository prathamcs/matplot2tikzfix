...
def draw_pathcollection(data: TikzData, obj: PathCollection) -> list[str]:
    ...
    # - For contours: iterate paths and let _draw_PC _draw_contour set dd_strings.
    # - For scatters: emit exactly one plot
    # using offsets; do NOT draw contour paths (marker geometry).
