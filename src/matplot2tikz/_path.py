...
def draw_pathcollection(data: TikzData, obj: PathCollection) -> list[str]:
    ...
    # IMPORTANT:
    # - For contours: iterate paths and let _draw_pathcollection_draw_contour set dd_strings.
    # - For scatters: emit exactly one plot using offsets; do NOT draw contour paths (marker geometry).
